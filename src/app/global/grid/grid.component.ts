...
export class GridComponent implements OnInit {
  ...
  columnDefs = [
    ...
    {field: 'diameter'},
    {field: 'density'},
    {field: 'escapeVelocity'},
    {field: 'rotationPeriod'},
    {field: 'lengthOfDay'},
    {field: 'distanceFromSun'},
    {field: 'perihelion'},
    {field: 'aphelion'},
    {field: 'orbitalPeriod'},
    {field: 'orbitalVelocity'},
    {field: 'orbitalInclination'},
    {field: 'orbitalEccentricity'},
    {field: 'obliquityToOrbit'},
    {field: 'meanTemperature'},
    {field: 'surfacePressure'},
    {field: 'numberOfMoons'},
    {field: 'hasRingSystem'},
    {field: 'hasGlobalMagneticField'},
];
...
//Add a new planet 
//how does that balance the equation of the planets in the system